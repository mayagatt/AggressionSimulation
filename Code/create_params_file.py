...
def change_two_params(params, param1, param1_arr, param2, param2_arr):
    """
...
if __name__ == "__main__":
    ...
    PARSER.add_argument('-o', type=str, required=True, help='Output file, including suffix')
    parser = PARSER.parse_args()
    out_file = parser.o

    params = {'log10c0': 1, 'x': 0, 'rhoA': 0.5, 'rhoV': 0.5, 'K': 1, 'K_L': 1, 'E': 2, 'DeltaE': 0.1, 'deltaL': 1,
    ...
    df, tot_len = change_two_params(params, param1='deltaL', param2='log10c0', param1_arr=deltaLs, param2_arr=log10c0s)
    df.to_csv(out_file)
    print('Param file length: ', tot_len)
